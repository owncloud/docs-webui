...
NOTE: Consider that this user guide covers the lates ownCloud version and the latest app versions only. This is because there would be too many dependencies and possibilites to cover. If you are using older versions, some items may not be present or look different.
