...
NOTE: On Windows 10 you need to turn on the network discovery. The following steps need to be done:

. Go to the windows settings
. Select "Network & Internet"
image:files/access_webdav/network-internet.png[]
. Select "Network and Sharing Center"
image:files/access_webdav/network-sharing-center.png[]
. Select "Change advanced sharing settings"
image:files/access_webdav/advanced-sharing-settings.png[]
. Select "Turn on network discovery"
image:files/access_webdav/network-discovery.png[]
