...
On Windows 10, you need to turn on the _Network Discovery_ to make webdav access working. In newer versions of Windows 10 is enabled but default.
...
+
image:files/access_webdav/network-internet.png[width=400]

. Select "Network and Sharing Center"
+
image:files/access_webdav/network-sharing-center.png[width=400]

. Select "Change advanced sharing settings"
+
image:files/access_webdav/advanced-sharing-settings.png[width=400]

. Select "Turn on network discovery"
+
image:files/access_webdav/network-discovery.png[width=400]
