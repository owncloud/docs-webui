...
{description} This tab contains the history of the file where you can roll back a file to any previous version. Changes made at intervals greater than two minutes are saved in data/[user]/versions.

image:files_versioning.png[image]

include::partial$/direct_file_access_tip.adoc[]
