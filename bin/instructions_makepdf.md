...
In most cases it is a good idea to copy the contents of an existing repo and adopt them to the needs. In particular, you need to take care of the following folders and files.
